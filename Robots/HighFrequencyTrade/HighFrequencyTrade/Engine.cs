...
public partial class HighFrequencyTrade : Robot
{
    private RobotBridge _robot;
    private const string MainPythonFile = "HighFrequencyTrade_main.py";
    ...
    protected override void OnStart()
    {
        ...
        using (Py.GIL())
        {
            ...
            var className = nameof(HighFrequencyTrade);
    ...
    private bool IsPlatformSupported()
    {
        ...
        if (OperatingSystem.IsWindows() && version >= new Version(5, 4))
            return true;

        if (OperatingSystem.IsMacOS() && version >= new Version(5, 7))
            return true;
